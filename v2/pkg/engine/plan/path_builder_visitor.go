...
func (c *pathBuilderVisitor) planMutationRootWithPreviousPlanner(field *currentFieldInfo) (plannerIdx int, planned bool) {
	...
	if pathAdded := c.addPlannerPathForTypename(field, previousPlannerIdx, planningBehaviour); pathAdded {
		return previousPlannerIdx, true
	}
